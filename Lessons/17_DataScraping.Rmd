...
# child(number) helps us to select column. So basically, selector gadget helps us determine the html code for that specific feature we want to import. We are doing this in R using the package called rvest. 
